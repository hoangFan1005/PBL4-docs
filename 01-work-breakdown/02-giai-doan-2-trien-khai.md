...
11. **[A]** Tạo **VPC `10.0.0.0/16`** + **public subnet `10.0.1.0/24`** + **Internet Gateway** + **route table** (0.0.0.0/0 → IGW). **Không** dùng wizard tạo NAT Gateway. → [03 §VPC](../02-learning/03-cloud-va-aws.md)
12. **[A]** Tạo **Security Groups**: `sg-pbl4-web` (22 từ IP nhóm, 80/443 từ mọi nơi), `sg-pbl4-elk` (22 từ IP nhóm, 5601 từ IP nhóm, 5044 **nguồn = sg-pbl4-web**). **Không** `0.0.0.0/0` cho 22/5601/9200. → [03 §SG](../02-learning/03-cloud-va-aws.md) (sinh **E2**)
13. **[A]** Launch **EC2-WEB** + **EC2-ELK** (spec theo [03 §spec](../02-learning/03-cloud-va-aws.md)); gắn **1 Elastic IP** cho WEB (URL ổn định). Ghi bảng inventory ([Bàn giao #1](05-hop-dong-ban-giao.md)).
