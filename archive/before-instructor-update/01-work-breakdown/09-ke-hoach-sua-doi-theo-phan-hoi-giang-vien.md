...
Căn cứ: phản hồi giảng viên do Hoàng cung cấp trong cuộc trò chuyện. Đây là kế hoạch sửa đổi bộ Markdown và nội dung báo cáo; không phải xác nhận hệ thống đã triển khai hoặc kiểm thử. Các tài liệu hiện tại vẫn cần được cập nhật theo danh sách dưới đây.
