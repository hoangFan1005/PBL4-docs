...
|---|---|---|
| "hạ tầng cơ bản trên AWS" | Mạng ảo + máy chủ ảo tối thiểu để chạy được hệ thống | 1 VPC, 1 public subnet cho Web/NAT, 1 private subnet cho ELK, 2 EC2 → xem [chương 03](../02-learning/03-cloud-va-aws.md) |
